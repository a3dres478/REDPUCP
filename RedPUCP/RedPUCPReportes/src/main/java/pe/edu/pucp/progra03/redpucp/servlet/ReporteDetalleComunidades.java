 ...
 * @author andre
 */
//este se encarga de obtener las publicaciones por x usuario
@WebServlet(name = "ReporteDetalleComunidades", urlPatterns = {"/reportes/ReporteDetalleComunidades"})
public class ReporteDetalleComunidades extends HttpServlet {

    private final String NOMBRE_REPORTE = 
            "reportes/PublicacionesxUsuario.jasper";
    ...
    protected void doGet(
        ...
        try {
            ...
            if (reporte == null) {
                throw new FileNotFoundException("No se encontró el archivo 'Cursosxprofesores.jasper'");
            }
    ...
    public String getServletInfo() {
        return "Esta servlet genera el reporte de cursos por profesores.";
    }
}
