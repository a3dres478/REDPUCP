...
public class ComunidadResource {
    ...
    @GET
    @Path ("nombreparte/{nombreparte}")
    public List<Comunidad>listarComunidadesXNombre(@PathParam("nombreparte") String nombre){
        return this.comunidadBO.buscarComunidadesXNombres(nombre);
    }
