 ...
 * @author andre
 */
@WebServlet(name = "Reporte_detalle_comunidades", urlPatterns = {"/Reporte_detalle_comunidades"})
public class Reporte_detalle_comunidades extends HttpServlet {
 private final String NOMBRE_REPORTE = 
    ...
    protected void doGet(
        ...
        try {
            ...
            if (reporte == null) {
                throw new FileNotFoundException("No se encontró el archivo 'DetallePublicacionesRF014.jasper'");
            }

            Map<String, Object> parametros = new HashMap<>();
            int id = Integer.parseInt(request.getParameter("idComunidad"));
            int idUsuario=Integer.parseInt(request.getParameter("idUsuario"));
            parametros.put("idComunidad", id);
    ...
    public String getServletInfo() {
        return "Esta servlet genera el subreportedepublicaciones";
    }
}
