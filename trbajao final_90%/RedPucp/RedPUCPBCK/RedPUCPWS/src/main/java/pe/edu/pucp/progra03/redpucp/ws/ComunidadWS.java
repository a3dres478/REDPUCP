...
//        ObjectMapper mapper= new ObjectMapper();
    ...
    @WebMethod (operationName ="listarComunidadesXParteNombre")
    public List<Comunidad> listarComunidadesXParteNombre(@WebParam(name="nombreparte")String nombreparte)throws Exception{
