...
//        ObjectMapper mapper = new ObjectMapper();
    ...
    @WebMethod(operationName = "verificarLoginUsuarioComun")
    public boolean verificarLogin(@WebParam(name = "email") String email, 
    ...
    public Usuario_comun obtenerUsuarioPorCorreo(@WebParam(name = "correo") String correo) throws Exception {
    ...
    @WebMethod(operationName = "actualizarKarma")
    public void actualizarKarma(@WebParam(name = "idUsuario") int idUsuario, 
                               @WebParam(name = "aumento") int aumento) {
        try {
            String url = this.urlBase + "/" + this.NOMBRE_RECURSO + "/" + idUsuario + "/karma/" + aumento;
